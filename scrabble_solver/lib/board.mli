...
(** [row_to_string board r] returns the string representation of the [r]th row of [board]*)
val col_to_string : t -> int -> string
(** [col_to_string board c] returns the string representation of the [c]th column of [board]*)
val board_to_string : t -> string
(** [board_to_string board] returns the string representation of the entire board *)
val validate_board : t -> Word.t -> Dictionary.t -> bool
(** [validate_board board] returns true if all words on [board] are valid words in the scrabble dictionary*)